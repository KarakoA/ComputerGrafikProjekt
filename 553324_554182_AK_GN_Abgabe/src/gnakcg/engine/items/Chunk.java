...
import static gnakcg.engine.items.Terrain.CHUNK_SIZE;

/**
 * Represents a chunk in the game world.
 * The methods for height interpolation(getTriangles and interpolateHeight)
 * was adapted from the LWJGL Book Chapter 15 where they are used in conjunction
 * with bounding boxes for collision detection. We don't need bounding boxes since we have
 * the concept of chunks and store the current in which the player is located.
 *
 * @author Anton K.
 * @author Gires N.
 */
